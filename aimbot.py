        ...
        for i in range(1, 32):
            ...
            if entity:
                ...
                if localTeam != entity_team_id and entity_hp > 0:
                    ...
                    try:
                        entitypos_x = pm.read_float(entity_bones + 0x30 * 7 + 0xC)
                        entitypos_y = pm.read_float(entity_bones + 0x30 * 7 + 0x1C)
                        entitypos_z = pm.read_float(entity_bones + 0x30 * 7 + 0x2C) - 27
                    except:
                        continue
